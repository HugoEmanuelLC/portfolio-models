            ...
            <div className="right">
                ...
                <section className='formation'>
                    ...
                    <p>Formation professionnelle avec une approche pédagogique active, réalisation de projets en solo et 
                        ...
                        Perfectionnement de <strong className='strong'>HTML5</strong> et <strong className='strong'>CSS3</strong>, 
                        les langages <strong className='strong'>JavaScript</strong> et ça librairie <strong className='strong'>Reactjs</strong> entre autres, 
                        les accès à des <strong className='strong'>API</strong> externes ou créer par nous mêmes, <strong className='strong'>Nodejs</strong> avec 
                        <strong className='strong'>Express</strong>, <strong className='strong'>MongoDB</strong> ou <strong className='strong'>Appwrite</strong>, 
                        ...
                        pour <strong className='strong'>Android</strong> et <strong className='strong'>ios</strong> à l'aide de <strong className='strong'>React Native</strong> et sont 
                        <strong className='strong'> framework</strong> <strong className='strong'>Expo</strong> ainsi que la configuration d'un <strong className='strong'>VPS</strong> 
                        et d'un <strong className='strong'>DNS</strong>.</p>
